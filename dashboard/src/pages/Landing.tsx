    ...
    <div className="min-h-screen bg-base-100 flex flex-col font-sans">
      ...
      <nav className="sticky top-0 z-50 bg-[#0d1117]/80 backdrop-blur-md border-b border-white/10 py-4">
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-12">
            <Link
              to="/"
              className="text-xl font-bold text-white no-underline flex items-center gap-2 hover:opacity-80 transition-opacity"
            >
        ...
        <div className="hero-content text-center">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-base-content/80 mb-12 max-w-3xl mx-auto">
              The self-hosted iOS CI runner for Apple Silicon. 50% faster builds, 90% lower costs,
      ...
      >
        <div className="max-w-7xl mx-auto px-8 flex flex-col lg:flex-row items-center gap-24">
          <div className="flex-1 min-w-0">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-br from-white to-[#a371f7] bg-clip-text text-transparent">
              ...
              {activeTab === 'python' ? (
                <pre className="m-0">
                  <code>
                    ...
                    <span className="text-[#8b949e] italic">
                      # Trigger a build from an AI agent
                    </span>
                    response = requests.post(
                    <span className="text-[#a5d6ff]">"https://api.alloy-ci.dev/v1/jobs"</span>,
                    headers=<span className="text-[#79c0ff]">{'{'}</span>
                    <span className="text-[#a5d6ff]">"Authorization"</span>:{' '}
                    <span className="text-[#a5d6ff]">
                      f"Bearer <span className="text-[#d2a8ff]">{'{api_key}'}</span>"
                    </span>
                    <span className="text-[#79c0ff]">{'}'}</span>, json=
                    <span className="text-[#79c0ff]">{'{'}</span>
                    <span className="text-[#a5d6ff]">"repo"</span>:{' '}
                    <span className="text-[#a5d6ff]">"my-ios-app"</span>,{' '}
                    <span className="text-[#a5d6ff]">"branch"</span>:{' '}
                    <span className="text-[#a5d6ff]">"main"</span>
                    <span className="text-[#79c0ff]">{'}'}</span>) print(
                    <span className="text-[#a5d6ff]">
                      f"Build started:{' '}
                      <span className="text-[#d2a8ff]">{"{response.json()['id']}"}</span>"
                    </span>
                    )
                  </code>
                </pre>
                ...
                <pre className="m-0">
                  <code>
                    ...
                    curl -X POST https://api.alloy-ci.dev/v1/jobs \ -H{' '}
                    <span className="text-[#a5d6ff]">"Authorization: Bearer $ALLOY_API_KEY"</span> \
                    -d{' '}
                    <span className="text-[#a5d6ff]">
                      '{'{"repo": "my-ios-app", "branch": "main"}'}'
                    </span>
                  </code>
                </pre>
              )}
      ...
      <section className="py-24 px-8 max-w-5xl mx-auto text-center" id="pricing">
        <h2 className="text-4xl lg:text-5xl font-extrabold mb-4 tracking-tight">
          Why switch to Alloy CI?
        </h2>
        <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto">
          Stop paying the "GitHub Tax" for slow cloud runners.
        </p>
        <div className="mt-12 bg-[#161b22] border border-white/10 rounded-xl overflow-hidden overflow-x-auto">
          <table className="w-full border-collapse">
            <thead>
              <tr>
                <th className="p-6 bg-[#0d1117] font-bold text-gray-400 text-left border-b border-white/10">
                  Feature
                </th>
                <th className="p-6 bg-[#58a6ff]/5 font-bold text-left border-b border-white/10">
                  Alloy CI (Self-Hosted)
                </th>
                <th className="p-6 bg-[#0d1117] font-bold text-gray-400 text-left border-b border-white/10">
                  GitHub Actions
                </th>
            ...
            <tbody>
              <tr className="border-b border-white/10 last:border-0 hover:bg-[#1c2229] transition-colors">
                ...
                <td className="p-6 bg-[#58a6ff]/5 font-bold text-[#3fb950] text-left">
                  ~1s (Instant)
                </td>
              ...
              <tr className="last:border-0 hover:bg-[#1c2229] transition-colors">
                ...
                <td className="p-6 bg-[#58a6ff]/5 text-left">
                  <span className="inline-block bg-[#3fb950]/15 text-[#3fb950] px-3 py-1 rounded-full text-sm font-semibold">
                    100% Yours
                  </span>
                </td>
      ...
      <section className="py-32 px-8 text-center bg-gradient-to-b from-[#0d1117] to-[#388bfd]/10">
        ...
        <p className="text-xl text-gray-400 mb-12">
          Join hundreds of mobile teams shipping faster with Alloy CI and Tart.
        </p>
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <a
            href="https://github.com/ekim1394/alloy"
            className="btn btn-outline btn-lg px-8 text-lg font-bold hover:bg-white hover:text-black gap-2"
            target="_blank"
            rel="noopener noreferrer"
          >
